...
export const InfoTooltip: React.FC<{ text: string }> = ({ text }) => {
  return (
    <div className="group relative inline-flex ml-1.5">
      ...
      <div className="absolute bottom-full left-1/2 -translate-x-1/2 w-56 mb-2 p-2 bg-slate-700 text-slate-200 text-xs text-center rounded-md shadow-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10">
        {text}
      </div>
    </div>
  );
